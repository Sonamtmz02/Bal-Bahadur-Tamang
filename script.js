(function () {
    ...
    /* Profile photo: graceful fallback + smooth fade-in when loaded */
    ...
    /* Favicon: default BT monogram in HTML; upgrade to profile photo if it exists */
    function initFavicon() {
        ...
        test.onerror = () => {
            /* keep the built-in BT monogram favicon */
        };
        test.src = photoUrl;
    }
